...
public sealed record MaintainArrProcessAuditPackageGenerationJobsResult(
    int CandidatesFound,
    int CompletedCount,
    int FailedCount,
    int SkippedCount);

public sealed class MaintainArrAuditPackageGenerationClient(
    HttpClient httpClient,
    IOptions<MaintainArrAuditPackageGenerationOptions> options)
{
    public async Task<MaintainArrProcessAuditPackageGenerationJobsResult> ProcessBatchAsync(
        CancellationToken cancellationToken)
    {
        ...
        return new MaintainArrProcessAuditPackageGenerationJobsResult(
