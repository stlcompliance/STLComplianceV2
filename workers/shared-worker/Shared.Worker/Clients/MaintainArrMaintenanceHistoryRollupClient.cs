...
public sealed record MaintainArrProcessMaintenanceHistoryRollupsResult(
    int CandidatesFound,
    int RefreshedCount,
    int SkippedCount);

public sealed class MaintainArrMaintenanceHistoryRollupClient(
    HttpClient httpClient,
    IOptions<MaintainArrMaintenanceHistoryRollupOptions> options)
{
    public async Task<MaintainArrProcessMaintenanceHistoryRollupsResult> ProcessBatchAsync(
        CancellationToken cancellationToken)
    {
        ...
        return new MaintainArrProcessMaintenanceHistoryRollupsResult(
