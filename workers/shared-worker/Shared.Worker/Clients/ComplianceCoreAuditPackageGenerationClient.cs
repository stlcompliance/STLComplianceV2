...
public sealed record ComplianceCoreProcessAuditPackageGenerationJobsResult(
    int CandidatesFound,
    int CompletedCount,
    int FailedCount,
    int SkippedCount);

public sealed class ComplianceCoreAuditPackageGenerationClient(
    HttpClient httpClient,
    IOptions<ComplianceCoreAuditPackageGenerationOptions> options)
{
    public async Task<ComplianceCoreProcessAuditPackageGenerationJobsResult> ProcessBatchAsync(
        CancellationToken cancellationToken)
    {
        ...
        return new ComplianceCoreProcessAuditPackageGenerationJobsResult(
