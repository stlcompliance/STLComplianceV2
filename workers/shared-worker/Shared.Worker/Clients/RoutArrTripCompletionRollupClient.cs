...
public sealed record RoutArrProcessTripCompletionRollupsResult(
    int CandidatesFound,
    int RefreshedCount,
    int SkippedCount);

public sealed class RoutArrTripCompletionRollupClient(
    HttpClient httpClient,
    IOptions<RoutArrTripCompletionRollupOptions> options)
{
    public async Task<RoutArrProcessTripCompletionRollupsResult> ProcessBatchAsync(
        CancellationToken cancellationToken)
    {
        ...
        return new RoutArrProcessTripCompletionRollupsResult(
