...
public sealed record NexArrProcessPlatformAuditPackageGenerationJobsResult(
    int CandidatesFound,
    int CompletedCount,
    int FailedCount,
    int SkippedCount);

public sealed class NexArrPlatformAuditPackageGenerationClient(
    HttpClient httpClient,
    IOptions<NexArrPlatformAuditPackageGenerationOptions> options)
{
    public async Task<NexArrProcessPlatformAuditPackageGenerationJobsResult> ProcessBatchAsync(
        CancellationToken cancellationToken)
    {
        ...
        return new NexArrProcessPlatformAuditPackageGenerationJobsResult(
