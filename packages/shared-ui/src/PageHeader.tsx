...
export function PageHeader({
  ...
  return (
    <header className="mb-6 flex flex-col gap-4 rounded-lg border border-[var(--color-border-subtle)] bg-[var(--color-bg-surface)] p-4 shadow-sm shadow-slate-950/10 sm:flex-row sm:items-end sm:justify-between">
