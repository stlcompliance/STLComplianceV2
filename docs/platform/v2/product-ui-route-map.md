...
| CustomArr | `/customarr/customers`, `/customarr/contacts`, `/customarr/locations`, `/customarr/requirements`, `/customarr/contracts`, `/customarr/preferences`, `/customarr/onboarding`, `/customarr/eligibility` |
| RoutArr | `/routarr/dispatch`, `/routarr/routes`, `/routarr/trips`, `/routarr/stops`, `/routarr/proofs`, `/routarr/exceptions`, `/routarr/driver-equipment-readiness`, `/routarr/dock-appointments` |
