...
- `NexArr` owns platform admin access, service identity, tenant validation, and the admin shell.
- `ReferenceDataCore` is the platform-owned reference-data service implemented in NexArr.
...
This repo already treats NexArr as the platform control plane. ReferenceDataCore should follow that pattern:
...
- platform-owned data stays in NexArr
