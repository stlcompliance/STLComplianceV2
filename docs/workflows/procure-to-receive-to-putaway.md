...
| public product identity and UOM/package rules | Platform Reference Data service |
...
7. Platform Reference Data service resolves UPC/GTIN, manufacturer, package, and UOM where available.
...
loadarr -> reference_data_service: item/package lookup
...
3. Platform Reference Data service may resolve item identity.
