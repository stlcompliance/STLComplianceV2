# ReferenceDataCore — Public Identifier and Reference Entity Model
...
ReferenceAttachment may live in the consuming product or in ReferenceDataCore depending on implementation, but the consuming product owns the local business record.
