...
5. Confirm the user should see the standard ordinary product catalog for their active tenant membership.
...
- Data missing: tenant/filter/owner-service/degraded-read-model issue, not a tenant launch-status issue.
