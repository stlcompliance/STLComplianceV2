...
5. Remember that every ordinary product is available to active tenant members; do not search for a product launch check.
...
- Data missing: tenant/filter/owner-service/degraded-read-model issue, not a product launch availability issue.
