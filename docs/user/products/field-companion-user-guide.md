# Field Companion User Guide

## What This Product Is For
Field Companion is for mobile task inbox, guided execution screens, file capture surfaces, task acknowledgment, offline-capable field actions, and product launch from field tasks.
...
- evidence upload attached to an owning product

## Common Workflows
- view assigned work
- acknowledge tasks
- open tasks in the owning product
- save and complete mobile inspection answers
- submit DVIR or evidence where task type supports it
- sync queued actions
