# STL Compliance User Documentation

These guides are for end users of the STL Compliance platform. They explain what users can do, where to go, what to check when something is missing, and which product owns each record.
...
## Managers
- [Maintenance manager guide](roles/maintenance-manager-guide.md)
- [ReportArr guide](products/reportarr-user-guide.md)
- [Asset defect to repair](workflows/asset-defect-to-repair.md)
- [Part request to receiving](workflows/part-request-to-receiving.md)

## Technicians/operators
- [Technician guide](roles/technician-guide.md)
- [Operator guide](roles/operator-guide.md)
- [Field Companion guide](products/field-companion-user-guide.md)
- [How to complete a mobile inspection](how-to/field-companion/how-to-complete-a-mobile-inspection.md)

## Dispatchers
- [Dispatcher guide](roles/dispatcher-guide.md)
- [RoutArr guide](products/routarr-user-guide.md)
- [Dispatch to completion](workflows/dispatch-to-completion.md)

## Warehouse users
- [Warehouse receiver guide](roles/warehouse-receiver-guide.md)
- [LoadArr guide](products/loadarr-user-guide.md)
- [How to receive inbound goods](how-to/loadarr/how-to-receive-inbound-goods.md)
- [PO to putaway](workflows/po-to-putaway.md)

## Trainers
- [Trainer guide](roles/trainer-guide.md)
- [TrainArr guide](products/trainarr-user-guide.md)
- [How to assign training](how-to/trainarr/how-to-assign-training.md)
- [How to sign off training](how-to/trainarr/how-to-sign-off-training.md)

## Compliance users
- [Compliance admin guide](roles/compliance-admin-guide.md)
- [AssurArr guide](products/assurarr-user-guide.md)
- [How to create a nonconformance](how-to/assurarr/how-to-create-a-nonconformance.md)
...
## Product guides
- [NexArr](products/nexarr-user-guide.md)
- [StaffArr](products/staffarr-user-guide.md)
...
- [AssurArr](products/assurarr-user-guide.md)
