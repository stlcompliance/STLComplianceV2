...
Every active tenant member should see the same ordinary product catalog. A missing product points to launcher cache, product registry/operational state, or launch configuration. Compliance Core's administrative studio is intentionally hidden unless you are a platform administrator.
