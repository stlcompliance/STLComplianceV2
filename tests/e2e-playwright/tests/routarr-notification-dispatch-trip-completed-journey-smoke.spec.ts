...
import {
  ensureRoutArrDispatchNotificationTripCompletedJourneyFixture,
...
test.describe('RoutArr trip-completed notification dispatch journey @requires-live', () => {
  ...
  test.beforeAll(async ({}, testInfo) => {
    ...
    try {
      const fixture = await ensureRoutArrDispatchNotificationTripCompletedJourneyFixture()
  ...
  test('status change to completed enqueues trip_completed dispatch outbox row visible in settings Recent dispatches', async ({
    page,
  }) => {
