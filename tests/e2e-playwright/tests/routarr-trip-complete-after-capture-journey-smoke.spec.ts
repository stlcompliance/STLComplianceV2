...
import { ensureRoutArrTripCompleteAfterCaptureFixture } from '../support/e2eApi.js'
...
test.describe('RoutArr trip complete after capture journey @requires-live', () => {
  ...
  test('handoff completes trip after post-trip DVIR photo then verifies dispatch read panel', async ({
    page,
  }) => {
