...
import { ensureRoutArrAttachmentDownloadFixture } from '../support/e2eApi.js'
...
test.describe('RoutArr dispatch proof/DVIR read attachment download @requires-live', () => {
  ...
  test.beforeAll(async ({}, testInfo) => {
    ...
    try {
      const fixture = await ensureRoutArrAttachmentDownloadFixture()
  ...
  test('handoff loads dispatch proof/DVIR read panel and downloads proof attachment', async ({
    page,
  }) => {
