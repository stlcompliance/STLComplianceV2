...
public sealed class StlProductLaunchEndpointMappingCatalogTests
{
    ...
    [InlineData("apps/ordarr-api/OrdArr.Api/Program.cs")]
    ...
    [InlineData("apps/recordarr-api/RecordArr.Api/Program.cs")]
    [InlineData("apps/reportarr-api/ReportArr.Api/Program.cs")]
