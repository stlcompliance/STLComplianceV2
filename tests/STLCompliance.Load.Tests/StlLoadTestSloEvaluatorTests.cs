...

{
    ...
    public void EngineeringDefaults_includes_five_scenarios()

    {

        Assert.Equal(5, StlLoadTestSloCatalog.EngineeringDefaults.Count);
    ...
    public void GetByScenarioKey_returns_known_scenario()
    ...
    public void GetByScenarioKey_returns_authenticated_scenario()

    {

        var target = StlLoadTestSloCatalog.GetByScenarioKey(StlLoadTestSloCatalog.NexArrAuthMeKey);
    ...
    public void GetByScenarioKey_returns_handoff_scenario()

    {

        var target = StlLoadTestSloCatalog.GetByScenarioKey(StlLoadTestSloCatalog.ProductAuthHandoffMeKey);

        Assert.Equal(8000, target.P95LatencyMsMax);
