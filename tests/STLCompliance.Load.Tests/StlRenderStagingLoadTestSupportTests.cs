...
public sealed class StlRenderStagingLoadTestSupportTests
{
    ...
    {
        Assert.Equal(9, StlRenderStagingLoadTestCatalog.All.Count);
        Assert.Contains(
    ...
    {
        Assert.Equal(9, StlRenderStagingLoadSoakScheduleCatalog.RequiredStagingApiUrlEnvironmentVariables.Count);
        Assert.Equal(
