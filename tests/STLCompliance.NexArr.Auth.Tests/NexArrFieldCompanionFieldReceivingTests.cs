...
public sealed class NexArrFieldCompanionFieldReceivingTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task Get_fieldcompanion_field_receiving_detail_proxies_to_supplyarr()
    {
    ...
    [Fact]
    public async Task Update_fieldcompanion_field_receiving_line_proxies_to_supplyarr()
    {
        var token = await LoginAsync(PlatformSeeder.DemoAdminEmail);
        ...
        var payload = (await response.Content.ReadFromJsonAsync<FieldCompanionFieldReceivingLineResponse>())!;
    ...
    [Fact]
    public async Task Post_fieldcompanion_field_receiving_proxies_to_supplyarr()
    {
        var token = await LoginAsync(PlatformSeeder.DemoAdminEmail);
