...
const allMarketingProducts: MarketingProduct[] = [
  ...
  },
  {
    ...
    recordsManaged: [
      ...
      'Eligibility and health snapshots',
      'Imports and merge review',
    ...
    readinessChecks: [
      ...
      'Requires eligibility checks before CustomArr portal order handoffs continue to OrdArr.',
    ],
    evidenceOutputs: [
      ...
      'Lead conversion and opportunity handoff history',
      'Proposal response and agreement reference history',
      'Import, duplicate review, and merge review history',
    ],
    handoffs: [
  ...
  },
  {
    ...
    primaryWorkflows: [
      'Manage journals, vendor bills, customer invoices, cash activity, and close support records.',
      'Track posting readiness, approvals, ledger snapshots, and financial exceptions.',
      'Keep financial evidence tied to the operational packets and transactions that produced it.',
    ],
    recordsManaged: [
      'Journals',
      'Vendor bills',
    ...
    readinessChecks: [
      'Checks whether packets, approvals, and supporting evidence are ready to post.',
      'Keeps close activity and financial controls visible before period lock or posting.',
      'Connects accounting records to the product evidence that generated them.',
    ],
    evidenceOutputs: [
      'Journal snapshots',
      'Invoice and bill histories',
      'Payment run outputs',
      'Period close records',
      'Posting exceptions',
    ],
    handoffs: [
      'Receives source packets and evidence references from product workflows.',
      'Provides posting and financial status back to operations teams.',
      'Supports audit and reporting workflows with financial evidence and close records.',
    ],
    checklist: checklist(
      ['auditEvidence'],
      ['secureAccess', 'orders', 'supply', 'warehouse', 'complianceRules'],
    ),
    connectedReasons: reasons({
      secureAccess: 'uses suite identity',
      orders: 'posts order-driven transactions',
      supply: 'tracks vendor bill context',
      warehouse: 'posts inventory valuations',
      complianceRules: 'supports close controls',
    }),
    icon: Landmark,
    sortOrder: 68,
    category: 'records',
    brandImageSrc: '/brand/ledgarr-fullcolor.png',
