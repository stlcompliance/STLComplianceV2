...
{
    /// <inheritdoc />
    public partial class SupplyArrSupplierFirstBaseline : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierId = table.Column<Guid>(type: "uuid", nullable: true),
                    SupplierKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    SupplierDisplayName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    ParentSupplierId = table.Column<Guid>(type: "uuid", nullable: true),
                    ParentSupplierDisplayName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    SupplierUnitKind = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    SupplierServiceTypesJson = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false, defaultValue: "[]"),
                    DocumentStatus = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_email_inbox_messages",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_email_inbox_messages", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "supplyarr_suppliers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    SupplierKey = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    ParentSupplierId = table.Column<Guid>(type: "uuid", nullable: true),
                    UnitKind = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false, defaultValue: "identity"),
                    DisplayName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ...
                    ServiceTypesJson = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false, defaultValue: "[]"),
                    ...
                    Locality = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false, defaultValue: ""),
                    RegionCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: ""),
                    PostalCode = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false, defaultValue: ""),
                    CountryCode = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false, defaultValue: ""),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_suppliers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_suppliers_supplyarr_suppliers_ParentSupplierId",
                        column: x => x.ParentSupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_tenant_supplier_order_settings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    AllowDestinationSummaryInSupplierPortal = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_tenant_supplier_order_settings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsStocked = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_supplyarr_contracts_supplyarr_suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_supplyarr_purchase_requests_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedSupplierQuoteId = table.Column<Guid>(type: "uuid", nullable: true),
                    PurchaseRequestId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_supplyarr_rfqs_supplyarr_suppliers_AwardedSupplierId",
                        column: x => x.AwardedSupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_compliance_documents",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_compliance_documents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_compliance_documents_supplyarr_suppliers~",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_contacts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_contacts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_contacts_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_onboarding",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_onboarding", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_onboarding_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_orders",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SupplierId = table.Column<Guid>(type: "uuid", nullable: false),
                    SupplierNameSnapshot = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ...
                    ParentSupplierOrderId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_orders_supplyarr_supplier_orders_ParentS~",
                        column: x => x.ParentSupplierOrderId,
                        principalTable: "supplyarr_supplier_orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_orders_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_restrictions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_restrictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_restrictions_supplyarr_suppliers_Supplie~",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_links",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    PartId = table.Column<Guid>(type: "uuid", nullable: false),
                    SupplierId = table.Column<Guid>(type: "uuid", nullable: false),
                    SupplierPartNumber = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_links", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_links_supplyarr_parts_PartId",
                        column: x => x.PartId,
                        principalTable: "supplyarr_parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_links_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_supplyarr_purchase_orders_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_rfq_supplier_invitations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_rfq_supplier_invitations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_rfq_supplier_invitations_supplyarr_rfqs_RfqId",
                        column: x => x.RfqId,
                        principalTable: "supplyarr_rfqs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_supplyarr_rfq_supplier_invitations_supplyarr_suppliers_Supp~",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_quotes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_quotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_quotes_supplyarr_rfqs_RfqId",
                        column: x => x.RfqId,
                        principalTable: "supplyarr_rfqs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_quotes_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_order_broker_decisions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_order_broker_decisions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_order_broker_decisions_supplyarr_supplie~",
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_order_document_links",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    UploadedBySupplierContactId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_order_document_links", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_order_document_links_supplyarr_supplier_~",
                        column: x => x.SupplierOrderId,
                        principalTable: "supplyarr_supplier_orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_order_magic_links",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_order_magic_links", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_order_magic_links_supplyarr_supplier_ord~",
                        column: x => x.SupplierOrderId,
                        principalTable: "supplyarr_supplier_orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_order_status_updates",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SubmittedBySupplierContactId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_order_status_updates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_order_status_updates_supplyarr_supplier_~",
                        column: x => x.SupplierOrderId,
                        principalTable: "supplyarr_supplier_orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierRestrictionId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_incidents_supplyarr_supplier_restriction~",
                        column: x => x.SupplierRestrictionId,
                        principalTable: "supplyarr_supplier_restrictions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_incidents_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_availability_capture_states",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    PartSupplierLinkId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_availability_capture_states", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_availability_capture_states_supplya~",
                        column: x => x.PartSupplierLinkId,
                        principalTable: "supplyarr_part_supplier_links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_availability_snapshots",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_availability_snapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_availability_snapshots_supplyarr_pa~",
                        column: x => x.PartSupplierLinkId,
                        principalTable: "supplyarr_part_supplier_links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_lead_time_capture_states",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_lead_time_capture_states", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_lead_time_capture_states_supplyarr_~",
                        column: x => x.PartSupplierLinkId,
                        principalTable: "supplyarr_part_supplier_links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_lead_time_snapshots",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_lead_time_snapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_lead_time_snapshots_supplyarr_part_~",
                        column: x => x.PartSupplierLinkId,
                        principalTable: "supplyarr_part_supplier_links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_price_capture_states",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_price_capture_states", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_price_capture_states_supplyarr_part~",
                        column: x => x.PartSupplierLinkId,
                        principalTable: "supplyarr_part_supplier_links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_part_supplier_pricing_snapshots",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_part_supplier_pricing_snapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_part_supplier_pricing_snapshots_supplyarr_part_su~",
                        column: x => x.PartSupplierLinkId,
                        principalTable: "supplyarr_part_supplier_links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_returns",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_returns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_returns_supplyarr_inventory_bins_Invento~",
                        column: x => x.InventoryBinId,
                        principalTable: "supplyarr_inventory_bins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_returns_supplyarr_purchase_orders_Purcha~",
                        column: x => x.PurchaseOrderId,
                        principalTable: "supplyarr_purchase_orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_returns_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_quote_lines",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_quote_lines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_quote_lines_supplyarr_rfq_lines_RfqLineId",
                        column: x => x.RfqLineId,
                        principalTable: "supplyarr_rfq_lines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_quote_lines_supplyarr_supplier_quotes_Su~",
                        column: x => x.SupplierQuoteId,
                        principalTable: "supplyarr_supplier_quotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "supplyarr_supplier_return_lines",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_supplyarr_supplier_return_lines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_return_lines_supplyarr_parts_PartId",
                        column: x => x.PartId,
                        principalTable: "supplyarr_parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_return_lines_supplyarr_purchase_order_li~",
                        column: x => x.PurchaseOrderLineId,
                        principalTable: "supplyarr_purchase_order_lines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_supplyarr_supplier_return_lines_supplyarr_supplier_returns_~",
                        column: x => x.SupplierReturnId,
                        principalTable: "supplyarr_supplier_returns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierRmaNumber = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    SupplierDisposition = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    SupplierResponseNotes = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false),
                    ...
                    SubmittedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    SubmittedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    SupplierRespondedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    SupplierRespondedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ClosedByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    ClosedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_supplyarr_warranty_claims_supplyarr_suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "supplyarr_suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_contracts_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_contracts_TenantId_SupplierId",
                table: "supplyarr_contracts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_capture_states_PartSup~",
                table: "supplyarr_part_supplier_availability_capture_states",
                column: "PartSupplierLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_capture_states_TenantI~",
                table: "supplyarr_part_supplier_availability_capture_states",
                columns: new[] { "TenantId", "PartSupplierLinkId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_capture_states_TenantId",
                table: "supplyarr_part_supplier_availability_capture_states",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_snapshots_PartSupplier~",
                table: "supplyarr_part_supplier_availability_snapshots",
                column: "PartSupplierLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_snapshots_TenantId",
                table: "supplyarr_part_supplier_availability_snapshots",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_snapshots_TenantId_Pa~1",
                table: "supplyarr_part_supplier_availability_snapshots",
                columns: new[] { "TenantId", "PartSupplierLinkId", "EffectiveTo" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_snapshots_TenantId_Par~",
                table: "supplyarr_part_supplier_availability_snapshots",
                columns: new[] { "TenantId", "PartSupplierLinkId", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_availability_snapshots_TenantId_Sna~",
                table: "supplyarr_part_supplier_availability_snapshots",
                columns: new[] { "TenantId", "SnapshotKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_capture_states_PartSuppli~",
                table: "supplyarr_part_supplier_lead_time_capture_states",
                column: "PartSupplierLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_capture_states_TenantId",
                table: "supplyarr_part_supplier_lead_time_capture_states",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_capture_states_TenantId_P~",
                table: "supplyarr_part_supplier_lead_time_capture_states",
                columns: new[] { "TenantId", "PartSupplierLinkId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_snapshots_PartSupplierLin~",
                table: "supplyarr_part_supplier_lead_time_snapshots",
                column: "PartSupplierLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_snapshots_TenantId",
                table: "supplyarr_part_supplier_lead_time_snapshots",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_snapshots_TenantId_PartS~1",
                table: "supplyarr_part_supplier_lead_time_snapshots",
                columns: new[] { "TenantId", "PartSupplierLinkId", "EffectiveTo" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_snapshots_TenantId_PartSu~",
                table: "supplyarr_part_supplier_lead_time_snapshots",
                columns: new[] { "TenantId", "PartSupplierLinkId", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_lead_time_snapshots_TenantId_Snapsh~",
                table: "supplyarr_part_supplier_lead_time_snapshots",
                columns: new[] { "TenantId", "SnapshotKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_links_PartId",
                table: "supplyarr_part_supplier_links",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_links_SupplierId",
                table: "supplyarr_part_supplier_links",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_links_TenantId",
                table: "supplyarr_part_supplier_links",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_links_TenantId_PartId",
                table: "supplyarr_part_supplier_links",
                columns: new[] { "TenantId", "PartId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_links_TenantId_PartId_SupplierId",
                table: "supplyarr_part_supplier_links",
                columns: new[] { "TenantId", "PartId", "SupplierId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_price_capture_states_PartSupplierLi~",
                table: "supplyarr_part_supplier_price_capture_states",
                column: "PartSupplierLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_price_capture_states_TenantId",
                table: "supplyarr_part_supplier_price_capture_states",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_price_capture_states_TenantId_PartS~",
                table: "supplyarr_part_supplier_price_capture_states",
                columns: new[] { "TenantId", "PartSupplierLinkId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_pricing_snapshots_PartSupplierLinkId",
                table: "supplyarr_part_supplier_pricing_snapshots",
                column: "PartSupplierLinkId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_pricing_snapshots_TenantId",
                table: "supplyarr_part_supplier_pricing_snapshots",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_pricing_snapshots_TenantId_PartSup~1",
                table: "supplyarr_part_supplier_pricing_snapshots",
                columns: new[] { "TenantId", "PartSupplierLinkId", "EffectiveTo" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_pricing_snapshots_TenantId_PartSupp~",
                table: "supplyarr_part_supplier_pricing_snapshots",
                columns: new[] { "TenantId", "PartSupplierLinkId", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_part_supplier_pricing_snapshots_TenantId_Snapshot~",
                table: "supplyarr_part_supplier_pricing_snapshots",
                columns: new[] { "TenantId", "SnapshotKey" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_purchase_orders_SupplierId",
                table: "supplyarr_purchase_orders",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_purchase_requests_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_rfq_supplier_invitations_RfqId",
                table: "supplyarr_rfq_supplier_invitations",
                column: "RfqId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_rfq_supplier_invitations_SupplierId",
                table: "supplyarr_rfq_supplier_invitations",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_rfq_supplier_invitations_TenantId",
                table: "supplyarr_rfq_supplier_invitations",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_rfq_supplier_invitations_TenantId_RfqId_PortalAcc~",
                table: "supplyarr_rfq_supplier_invitations",
                columns: new[] { "TenantId", "RfqId", "PortalAccessCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_rfq_supplier_invitations_TenantId_RfqId_SupplierId",
                table: "supplyarr_rfq_supplier_invitations",
                columns: new[] { "TenantId", "RfqId", "SupplierId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_rfqs_AwardedSupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_compliance_documents_SupplierId",
                table: "supplyarr_supplier_compliance_documents",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_compliance_documents_TenantId",
                table: "supplyarr_supplier_compliance_documents",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_compliance_documents_TenantId_ExpiresAt",
                table: "supplyarr_supplier_compliance_documents",
                columns: new[] { "TenantId", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_compliance_documents_TenantId_ReviewStat~",
                table: "supplyarr_supplier_compliance_documents",
                columns: new[] { "TenantId", "ReviewStatus", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_compliance_documents_TenantId_SupplierId",
                table: "supplyarr_supplier_compliance_documents",
                columns: new[] { "TenantId", "SupplierId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_compliance_documents_TenantId_SupplierId~",
                table: "supplyarr_supplier_compliance_documents",
                columns: new[] { "TenantId", "SupplierId", "DocumentKey", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_contacts_SupplierId",
                table: "supplyarr_supplier_contacts",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_contacts_TenantId",
                table: "supplyarr_supplier_contacts",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_contacts_TenantId_SupplierId",
                table: "supplyarr_supplier_contacts",
                columns: new[] { "TenantId", "SupplierId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_email_inbox_messages_TenantId",
                table: "supplyarr_supplier_email_inbox_messages",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_email_inbox_messages_TenantId_LinkedRefe~",
                table: "supplyarr_supplier_email_inbox_messages",
                columns: new[] { "TenantId", "LinkedReferenceType", "LinkedReferenceId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_email_inbox_messages_TenantId_MatchStatu~",
                table: "supplyarr_supplier_email_inbox_messages",
                columns: new[] { "TenantId", "MatchStatus", "ReceivedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_email_inbox_messages_TenantId_MessageKey",
                table: "supplyarr_supplier_email_inbox_messages",
                columns: new[] { "TenantId", "MessageKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_email_inbox_messages_TenantId_MessageKin~",
                table: "supplyarr_supplier_email_inbox_messages",
                columns: new[] { "TenantId", "MessageKind", "ReceivedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_email_inbox_messages_TenantId_SupplierId~",
                table: "supplyarr_supplier_email_inbox_messages",
                columns: new[] { "TenantId", "SupplierId", "ReceivedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_incidents_SupplierId",
                table: "supplyarr_supplier_incidents",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_incidents_SupplierRestrictionId",
                table: "supplyarr_supplier_incidents",
                column: "SupplierRestrictionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_incidents_TenantId_SupplierId",
                table: "supplyarr_supplier_incidents",
                columns: new[] { "TenantId", "SupplierId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_onboarding_SupplierId",
                table: "supplyarr_supplier_onboarding",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_onboarding_TenantId",
                table: "supplyarr_supplier_onboarding",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_onboarding_TenantId_OnboardingStatus_Sub~",
                table: "supplyarr_supplier_onboarding",
                columns: new[] { "TenantId", "OnboardingStatus", "SubmittedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_onboarding_TenantId_SupplierId",
                table: "supplyarr_supplier_onboarding",
                columns: new[] { "TenantId", "SupplierId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_broker_decisions_SupplierOrderId",
                table: "supplyarr_supplier_order_broker_decisions",
                column: "SupplierOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_broker_decisions_TenantId",
                table: "supplyarr_supplier_order_broker_decisions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_broker_decisions_TenantId_Supplier~",
                table: "supplyarr_supplier_order_broker_decisions",
                columns: new[] { "TenantId", "SupplierOrderId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_document_links_SupplierOrderId",
                table: "supplyarr_supplier_order_document_links",
                column: "SupplierOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_document_links_TenantId",
                table: "supplyarr_supplier_order_document_links",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_document_links_TenantId_SupplierOr~",
                table: "supplyarr_supplier_order_document_links",
                columns: new[] { "TenantId", "SupplierOrderId", "UploadedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_magic_links_SupplierOrderId",
                table: "supplyarr_supplier_order_magic_links",
                column: "SupplierOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_magic_links_TenantId",
                table: "supplyarr_supplier_order_magic_links",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_magic_links_TenantId_ExpiresAt",
                table: "supplyarr_supplier_order_magic_links",
                columns: new[] { "TenantId", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_magic_links_TenantId_SupplierOrder~",
                table: "supplyarr_supplier_order_magic_links",
                columns: new[] { "TenantId", "SupplierOrderId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_magic_links_TenantId_TokenHash",
                table: "supplyarr_supplier_order_magic_links",
                columns: new[] { "TenantId", "TokenHash" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_status_updates_SupplierOrderId",
                table: "supplyarr_supplier_order_status_updates",
                column: "SupplierOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_status_updates_TenantId",
                table: "supplyarr_supplier_order_status_updates",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_order_status_updates_TenantId_SupplierOr~",
                table: "supplyarr_supplier_order_status_updates",
                columns: new[] { "TenantId", "SupplierOrderId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_orders_ParentSupplierOrderId",
                table: "supplyarr_supplier_orders",
                column: "ParentSupplierOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_orders_SupplierId",
                table: "supplyarr_supplier_orders",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_orders_TenantId",
                table: "supplyarr_supplier_orders",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_orders_TenantId_BrokerOrderId",
                table: "supplyarr_supplier_orders",
                columns: new[] { "TenantId", "BrokerOrderId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_orders_TenantId_ParentSupplierOrderId",
                table: "supplyarr_supplier_orders",
                columns: new[] { "TenantId", "ParentSupplierOrderId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_orders_TenantId_SupplierId_Status_Update~",
                table: "supplyarr_supplier_orders",
                columns: new[] { "TenantId", "SupplierId", "Status", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quote_lines_RfqLineId",
                table: "supplyarr_supplier_quote_lines",
                column: "RfqLineId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quote_lines_SupplierQuoteId",
                table: "supplyarr_supplier_quote_lines",
                column: "SupplierQuoteId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quote_lines_TenantId",
                table: "supplyarr_supplier_quote_lines",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quote_lines_TenantId_SupplierQuoteId_Rfq~",
                table: "supplyarr_supplier_quote_lines",
                columns: new[] { "TenantId", "SupplierQuoteId", "RfqLineId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quotes_RfqId",
                table: "supplyarr_supplier_quotes",
                column: "RfqId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quotes_SupplierId",
                table: "supplyarr_supplier_quotes",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quotes_TenantId",
                table: "supplyarr_supplier_quotes",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quotes_TenantId_RfqId_QuoteKey",
                table: "supplyarr_supplier_quotes",
                columns: new[] { "TenantId", "RfqId", "QuoteKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_quotes_TenantId_RfqId_SupplierId",
                table: "supplyarr_supplier_quotes",
                columns: new[] { "TenantId", "RfqId", "SupplierId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_restrictions_SupplierId",
                table: "supplyarr_supplier_restrictions",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_restrictions_TenantId",
                table: "supplyarr_supplier_restrictions",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_restrictions_TenantId_Status_UpdatedAt",
                table: "supplyarr_supplier_restrictions",
                columns: new[] { "TenantId", "Status", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_restrictions_TenantId_SupplierId",
                table: "supplyarr_supplier_restrictions",
                columns: new[] { "TenantId", "SupplierId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_restrictions_TenantId_SupplierId_Restric~",
                table: "supplyarr_supplier_restrictions",
                columns: new[] { "TenantId", "SupplierId", "RestrictionKey", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_PartId",
                table: "supplyarr_supplier_return_lines",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_PurchaseOrderLineId",
                table: "supplyarr_supplier_return_lines",
                column: "PurchaseOrderLineId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_SupplierReturnId",
                table: "supplyarr_supplier_return_lines",
                column: "SupplierReturnId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_TenantId",
                table: "supplyarr_supplier_return_lines",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_TenantId_PartId",
                table: "supplyarr_supplier_return_lines",
                columns: new[] { "TenantId", "PartId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_TenantId_SupplierReturnId",
                table: "supplyarr_supplier_return_lines",
                columns: new[] { "TenantId", "SupplierReturnId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_return_lines_TenantId_SupplierReturnId_L~",
                table: "supplyarr_supplier_return_lines",
                columns: new[] { "TenantId", "SupplierReturnId", "LineNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_InventoryBinId",
                table: "supplyarr_supplier_returns",
                column: "InventoryBinId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_PurchaseOrderId",
                table: "supplyarr_supplier_returns",
                column: "PurchaseOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_SupplierId",
                table: "supplyarr_supplier_returns",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_TenantId",
                table: "supplyarr_supplier_returns",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_TenantId_PurchaseOrderId",
                table: "supplyarr_supplier_returns",
                columns: new[] { "TenantId", "PurchaseOrderId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_TenantId_ReturnKey",
                table: "supplyarr_supplier_returns",
                columns: new[] { "TenantId", "ReturnKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_TenantId_Status_UpdatedAt",
                table: "supplyarr_supplier_returns",
                columns: new[] { "TenantId", "Status", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_supplier_returns_TenantId_SupplierId",
                table: "supplyarr_supplier_returns",
                columns: new[] { "TenantId", "SupplierId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_suppliers_ParentSupplierId",
                table: "supplyarr_suppliers",
                column: "ParentSupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_suppliers_TenantId",
                table: "supplyarr_suppliers",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_suppliers_TenantId_ApprovalStatus",
                table: "supplyarr_suppliers",
                columns: new[] { "TenantId", "ApprovalStatus" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_suppliers_TenantId_ParentSupplierId",
                table: "supplyarr_suppliers",
                columns: new[] { "TenantId", "ParentSupplierId" });

            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_suppliers_TenantId_SupplierKey",
                table: "supplyarr_suppliers",
                columns: new[] { "TenantId", "SupplierKey" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_tenant_supplier_order_settings_TenantId",
                table: "supplyarr_tenant_supplier_order_settings",
                column: "TenantId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_warranty_claims_SupplierId",
                table: "supplyarr_warranty_claims",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplyarr_warranty_claims_TenantId_SupplierId",
                table: "supplyarr_warranty_claims",
                columns: new[] { "TenantId", "SupplierId" });
