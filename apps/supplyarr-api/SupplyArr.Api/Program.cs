...
await StlApiHost.RunAsync<SupplyArrDbContext>(
    ...
    async app =>
    {
        ...
        app.MapSupplyArrSupplierCatalogApiEndpoints();
        app.MapSupplyArrSupplierEmailInboxEndpoints();
        app.MapSupplyArrSupplierOrderSettingsEndpoints();
        ...
        app.MapSupplyArrSupplierPortalEndpoints();
        app.MapSupplyArrSupplierAccessEndpoints();
        app.MapSupplyArrSupplierOnboardingEndpoints();
        app.MapSupplyArrSupplierRestrictionEndpoints();
