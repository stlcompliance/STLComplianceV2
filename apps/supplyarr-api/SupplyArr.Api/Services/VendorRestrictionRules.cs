...
public static class VendorRestrictionRules
{
    public static string NormalizeRestrictionKey(string restrictionKey)
    {
        ...
        if (normalized.Length is < 2 or > 64)
        {
            throw new STLCompliance.Shared.Contracts.StlApiException(
                "vendor_restrictions.invalid_key",
    ...
    public static IReadOnlyList<string> NormalizeScopes(IReadOnlyList<string> scopes)
    {
        ...
        {
            throw new STLCompliance.Shared.Contracts.StlApiException(
                "vendor_restrictions.scopes_required",
        ...
        {
            if (!VendorRestrictionScopes.All.Contains(scope))
            {
                throw new STLCompliance.Shared.Contracts.StlApiException(
                    "vendor_restrictions.invalid_scope",
    ...
    public static bool IsRestrictionEffective(
        VendorRestriction restriction,
        DateTimeOffset asOfUtc) =>
        string.Equals(restriction.Status, VendorRestrictionStatuses.Active, StringComparison.OrdinalIgnoreCase)
    ...
    public static bool ScopeBlocks(
        ...
        restrictionScopes.Contains(VendorRestrictionScopes.AllProcurement, StringComparer.OrdinalIgnoreCase)
    ...
    public static string NormalizeReason(string reason)
    {
        ...
        {
            throw new STLCompliance.Shared.Contracts.StlApiException(
                "vendor_restrictions.invalid_reason",
