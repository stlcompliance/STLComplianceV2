...

{
...

    {
...

        {
            ...
            Status = SupplierReturnStatuses.Draft,

            SourceType = SupplierReturnSourceTypes.Stock,
...

        {
            ...
            entity.Lines.Add(new SupplierReturnLine
        ...
        await audit.WriteAsync(
            ...
            "supplier_return.create_from_stock",
...

    {
...

        {
            ...
            SourceType = SupplierReturnSourceTypes.PurchaseOrderLine,
            ...
            Supplier = await LoadSupplierAsync(tenantId, line.PurchaseOrder.SupplierId, cancellationToken),
        ...
        entity.Lines[0].SupplierReturnId = entity.Id;
        ...
        await audit.WriteAsync(
            ...
            "supplier_return.create_from_po_line",
...

    {
        ...
        entity.Status = SupplierReturnStatuses.Posted;
...

    {
        ...
        entity.Status = SupplierReturnStatuses.Cancelled;
    ...
    private static void EnsureDraft(SupplierReturn entity)

    {

        if (!SupplierReturnStatuses.Editable.Contains(entity.Status))

        {
            ...
            throw new StlApiException(
                ...
                "Supplier return can only be edited while in draft status.",
...

    {
        ...
        var duplicate = await db.SupplierReturns.AnyAsync(
...

        {
            ...
            throw new StlApiException(
                ...
                "A supplier return with this key already exists.",
    ...
    private async Task<SupplierReturn> LoadTrackedAsync(
    ...
    private static SupplierReturnResponse Map(SupplierReturn entity)
    ...
    private static SupplierReturnLineResponse MapLine(SupplierReturnLine line) =>
