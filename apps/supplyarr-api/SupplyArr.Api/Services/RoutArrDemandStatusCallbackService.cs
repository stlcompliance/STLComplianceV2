...
public sealed class RoutArrDemandStatusCallbackService(
    SupplyArrDbContext db,
    RoutArrDemandStatusClient routArrDemandStatusClient,
    ISupplyArrAuditService audit)
{
    public Task NotifyPrDraftedAsync(
        RoutArrDemandRef demandRef,
        ...
        NotifyDemandRefAsync(
            ...
            RoutArrDemandRefProcurementStatuses.PrDrafted,
            purchaseRequestId,
            null,
            null,
            null,
            "Purchase request draft created from RoutArr demand.",
            occurredAt,
            cancellationToken);
    ...
    public Task NotifyPurchaseRequestSubmittedAsync(
        ...
        NotifyByPurchaseRequestAsync(
            ...
            RoutArrDemandRefProcurementStatuses.PrSubmitted,
            null,
            null,
    ...
    public Task NotifyPurchaseRequestApprovedAsync(
        ...
        NotifyByPurchaseRequestAsync(
            ...
            RoutArrDemandRefProcurementStatuses.PrApproved,
            null,
            null,
    ...
    public Task NotifyPurchaseRequestRejectedAsync(
        ...
        NotifyByPurchaseRequestAsync(
            ...
            RoutArrDemandRefProcurementStatuses.PrRejected,
            null,
            null,
    ...
    public Task NotifyPurchaseOrderCreatedAsync(
        ...
        NotifyByPurchaseRequestAsync(
            ...
            RoutArrDemandRefProcurementStatuses.PoCreated,
            purchaseOrderId,
            null,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var procurementStatus = fullyReceived
            ? RoutArrDemandRefProcurementStatuses.ReceivedComplete
            : RoutArrDemandRefProcurementStatuses.PartiallyReceived;
        ...
        CancellationToken cancellationToken)
    {
        ...
        await routArrDemandStatusClient.PublishStatusAsync(
            new RoutArrDemandStatusCallbackPayload(
                demandRef.TenantId,
                demandRef.RoutarrPublicationId,
                demandRef.Id,
        ...
        await audit.WriteAsync(
            "demand_status.routarr.callback",
            demandRef.TenantId,
            null,
            "routarr_demand_ref",
    ...
    private async Task<IReadOnlyList<RoutArrDemandRef>> LoadDemandRefsByPurchaseOrderAsync(
        Guid tenantId,
        Guid purchaseOrderId,
        CancellationToken cancellationToken)
    {
        ...
        return await db.RoutArrDemandRefs
