...
public static class AuditHistoryEndpoints
{
    public static void MapSupplyArrAuditHistoryEndpoints(this WebApplication app)
    {
        ...
        {
            group = group.WithTags("AuditHistory").RequireAuthorization();
            ...
            .WithName($"ListSupplyArrAuditHistory{nameSuffix}");
        }

        MapRoutes(app.MapGroup("/api/audit-history"), string.Empty);
        MapRoutes(app.MapGroup("/api/v1/audit-history"), "V1");
    }
}
