...
public static class SupplierOnboardingEndpoints
{
    ...
    {
        var group = app.MapGroup("/api/supplier-onboarding")
            .WithTags("SupplierOnboarding")
        ...
        .WithName("GetSupplierOnboardingDocumentRequirements");
        ...
        .WithName("UpsertSupplierOnboardingDocumentRequirements");
        ...
        .WithName("ListPendingSupplierOnboarding");
        ...
        .WithName("StartSupplierOnboarding");
        ...
        .WithName("GetSupplierOnboardingByParty");
        ...
        .WithName("SubmitSupplierOnboardingForReview");
        ...
        .WithName("ApproveSupplierOnboarding");
        ...
        .WithName("RejectSupplierOnboarding");
        ...
        .WithName("SuspendSupplierOnboarding");

        var partyDocs = app.MapGroup("/api/parties/{partyId:guid}/compliance-documents")
            .WithTags("PartyComplianceDocuments")
            .RequireAuthorization();
        ...
        .WithName("ListPartyComplianceDocuments");
        ...
        .WithName("RegisterPartyComplianceDocument");
        ...
        .WithName("ApprovePartyComplianceDocument");
        ...
        .WithName("RejectPartyComplianceDocument");
    }
}
