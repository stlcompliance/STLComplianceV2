...
public static class InternalProcurementNotificationEndpoints
{
    public static void MapSupplyArrInternalProcurementNotificationEndpoints(this WebApplication app)
    {
        var internalApi = app.MapGroup("/api/internal/procurement-notifications")
            .WithTags("Internal");
        ...
        .WithName("InternalListPendingProcurementNotifications");
        ...
        .WithName("InternalProcessProcurementNotifications");
    }
        ...
        Guid? tenantId)
    {
        ...
        if (!string.Equals(preview.SourceProductKey, "shared-worker", StringComparison.OrdinalIgnoreCase))
        {
            throw new StlApiException(
                ...
                "Service token source product is not authorized for procurement notification delivery.",
                403);
        }
        ...
        tokenValidator.ValidateOrThrow(
            ...
            new ServiceTokenRequirements
            {
                ...
                RequiredActionScope = ProcurementNotificationDispatchService.ProcessNotificationsActionScope,
            });
    }
}
