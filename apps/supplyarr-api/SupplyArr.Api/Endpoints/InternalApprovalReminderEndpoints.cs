...
public static class InternalApprovalReminderEndpoints
{
    public static void MapSupplyArrInternalApprovalReminderEndpoints(this WebApplication app)
    {
        var internalApi = app.MapGroup("/api/internal/approval-reminders").WithTags("Internal");
        ...
        internalApi.MapGet("/pending", async (
            ...
            [FromServices] ApprovalReminderWorkerService service,
        ...
        .WithName("InternalListPendingApprovalReminders");

        internalApi.MapPost("/process-batch", async (
            [FromBody] ProcessApprovalRemindersRequest request,
            HttpContext context,
            [FromServices] StlServiceTokenValidator tokenValidator,
            [FromServices] ApprovalReminderWorkerService service,
            CancellationToken cancellationToken) =>
        ...
        .WithName("InternalProcessApprovalReminders");
    }
        ...
        Guid? tenantId)
    {
        ...
        if (!string.Equals(preview.SourceProductKey, "shared-worker", StringComparison.OrdinalIgnoreCase))
        {
            throw new StlApiException(
                ...
                "Service token source product is not authorized for approval reminders.",
                403);
        }
        ...
        tokenValidator.ValidateOrThrow(
            ...
            new ServiceTokenRequirements
            {
                ...
                RequiredActionScope = ApprovalReminderWorkerService.ProcessApprovalRemindersActionScope,
            });
    }
}
