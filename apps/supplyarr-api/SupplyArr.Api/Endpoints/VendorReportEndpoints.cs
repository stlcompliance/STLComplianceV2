...
public static class VendorReportEndpoints
{
    ...
    {
        var group = app.MapGroup("/api/reports/vendors")
            .WithTags("VendorReports")
        ...
        .WithName("GetSupplyArrVendorReportSummary");
        ...
        .WithName("GetSupplyArrVendorReportDetail");
        ...
        .WithName("ExportSupplyArrVendorReportSummary");
    }
}
