  ...
  return (
    ...
    >
      ...
      {summaryQuery.isError && (
        <div className="mt-3">
          <ApiErrorCallout
            title="Operator report unavailable"
            message={getErrorMessage(summaryQuery.error, 'Failed to load operator report summary.')}
      ...
      {exportMutation.isError && (
        <div className="mt-3">
          <ApiErrorCallout
            ...
            message={getErrorMessage(exportMutation.error, 'Unable to export operator report CSV.')}
          />
        </div>
      )}
