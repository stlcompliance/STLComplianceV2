...
vi.mock('../api/client', async (importOriginal) => {
  ...
  return {
    ...
    exportBulkFindingsCsv: vi.fn(),
    exportBulkEvaluationsCsv: vi.fn(),
    exportBulkRulePacksCsv: vi.fn(),
    exportBulkWorkflowGateChecksCsv: vi.fn(),
  }
})
...
describe('DataExportsPanel', () => {
  ...
  it('shows export failure callout', async () => {
    ...
    vi.mocked(client.exportBulkFindingsCsv).mockRejectedValue(new Error('export down'))
    renderPanel()
