...
public sealed class HandoffAuthService(
    ...
    LedgArrTokenService tokenService)
{
    private const string ProductKey = "ledgarr";

    public async Task<LedgArrHandoffSessionResponse> RedeemAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!string.Equals(redeemed.TargetProductKey, ProductKey, StringComparison.OrdinalIgnoreCase))
        {
            throw new StlApiException(
                ...
                "Handoff code is not intended for LedgArr.",
                403);
        }
        ...
        if (!redeemed.Entitlements.Contains(ProductKey, StringComparer.OrdinalIgnoreCase))
        {
            throw new StlApiException(
                ...
                "Tenant does not have an active LedgArr entitlement.",
                403);
        }
        ...
        return new LedgArrHandoffSessionResponse(
            accessToken,
            expiresAt,
