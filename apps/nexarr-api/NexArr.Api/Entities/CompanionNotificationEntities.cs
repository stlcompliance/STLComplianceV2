...
public sealed class TenantCompanionNotificationSettings : IHasTenant
{
...
public sealed class CompanionNotificationDispatch : IHasTenant
{
    public Guid Id { get; set; }
...
public static class CompanionNotificationEventKinds
{
...
public static class CompanionNotificationDispatchStatuses
{
