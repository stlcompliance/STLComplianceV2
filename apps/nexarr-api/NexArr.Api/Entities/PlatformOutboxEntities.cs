...
public static class PlatformOutboxEventKinds
{
    ...
    public const string TenantLaunchDestinationGranted = "tenant.launch_destination.granted";
    public const string TenantLaunchDestinationUpdated = "tenant.launch_destination.updated";
    public const string TenantLaunchDestinationRevoked = "tenant.launch_destination.revoked";
    public const string TenantAvailabilityGranted = TenantLaunchDestinationGranted;
    public const string TenantAvailabilityUpdated = TenantLaunchDestinationUpdated;
    public const string TenantAvailabilityRevoked = TenantLaunchDestinationRevoked;
    public const string TenantEntitlementGranted = TenantAvailabilityGranted;
    public const string TenantEntitlementUpdated = TenantAvailabilityUpdated;
    public const string TenantEntitlementRevoked = TenantAvailabilityRevoked;
