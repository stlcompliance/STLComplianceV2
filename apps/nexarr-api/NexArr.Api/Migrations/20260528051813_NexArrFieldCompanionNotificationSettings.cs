...
{
    /// <inheritdoc />
    public partial class NexArrFieldCompanionNotificationSettings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_nexarr_fieldcompanion_notification_dispatches_TenantId_DispatchS~",
                table: "nexarr_fieldcompanion_notification_dispatches",
                columns: new[] { "TenantId", "DispatchStatus", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_nexarr_fieldcompanion_notification_dispatches_TenantId_EventKind~",
                table: "nexarr_fieldcompanion_notification_dispatches",
