...
{
    /// <inheritdoc />
    public partial class NexArrCompanionFieldSubmissions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "nexarr_companion_field_submissions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_nexarr_companion_field_submissions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "nexarr_companion_offline_actions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_nexarr_companion_offline_actions", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_nexarr_companion_field_submissions_TenantId_UserId_TaskKey_~",
                table: "nexarr_companion_field_submissions",
                columns: new[] { "TenantId", "UserId", "TaskKey", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_nexarr_companion_offline_actions_TenantId_IdempotencyKey",
                table: "nexarr_companion_offline_actions",
                columns: new[] { "TenantId", "IdempotencyKey" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_nexarr_companion_offline_actions_TenantId_UserId_SyncedAt",
                table: "nexarr_companion_offline_actions",
