...
public sealed class FieldCompanionFieldSubmissionService(NexArrDbContext db)
{
    ...
    {
        db.FieldCompanionFieldSubmissions.Add(new FieldCompanionFieldSubmission
        {
            Id = Guid.NewGuid(),
            TenantId = tenantId,
            UserId = userId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var submissions = await db.FieldCompanionFieldSubmissions.AsNoTracking()
