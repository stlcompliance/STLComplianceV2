...
public static class CompanionNotificationRules
{
    ...
    public static string? NormalizeWebhookUrl(string? raw, bool allowInsecureHttp)
    {
        ...
        if (trimmed.Length > MaxWebhookUrlLength)
        {
            throw new StlApiException(
                "companion.notification.webhook_too_long",
        ...
        {
            throw new StlApiException(
                "companion.notification.webhook_invalid",
        ...
        {
            throw new StlApiException(
                "companion.notification.webhook_invalid_scheme",
        ...
        {
            throw new StlApiException(
                "companion.notification.webhook_https_required",
