...
public static class PlatformSeeder
{
    ...
    [
        ...
        new("ordarr", "OrdArr", 57, "orders", "Order Operations", "available", "http://localhost:5112", "http://localhost:5112/health/ready", "stl:ordarr:api"),
    ...
    [
        ...
        ("customarr", "http://localhost:5186", "/launch"),
        ("ordarr", "http://localhost:5187", "/launch"),
