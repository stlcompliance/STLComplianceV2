...
public static class CompanionOfflineEndpoints
{
    ...
    {
        app.MapLegacyAndCanonical("/api/companion/offline-actions", "/api/v1/mobile/offline-actions", (group, isCanonical) =>
        {
            ...
            if (isCanonical)
            {
                sync.WithName("SyncCompanionOfflineActions");
            }
            ...
            if (isCanonical)
            {
                list.WithName("ListCompanionOfflineActions");
            }
        });
    }
}
