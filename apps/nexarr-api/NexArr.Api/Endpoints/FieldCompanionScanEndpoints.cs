...
public static class FieldCompanionScanEndpoints
{
    public static void MapFieldCompanionScanEndpoints(this WebApplication app)
    {
        app.MapLegacyAndCanonical("/api/fieldcompanion/scan", "/api/v1/mobile/scan", (group, isCanonical) =>
        {
            ...
            var resolve = group.MapPost("/resolve", async (
                ...
                FieldCompanionScanResolveService service,
                HttpContext context,
            ...
            if (isCanonical)
            {
                resolve.WithName("FieldCompanionResolveScan");
            }
        });
    }
}
