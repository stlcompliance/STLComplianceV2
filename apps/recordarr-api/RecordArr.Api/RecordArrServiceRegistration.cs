...
public static class RecordArrServiceRegistration
{
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        builder.Services.Configure<RedactionOverlayReviewWorkerOptions>(builder.Configuration.GetSection(RedactionOverlayReviewWorkerOptions.SectionName));
        builder.Services.Configure<BackupVerificationWorkerOptions>(builder.Configuration.GetSection(BackupVerificationWorkerOptions.SectionName));
        builder.Services.Configure<AuditAnchorWorkerOptions>(builder.Configuration.GetSection(AuditAnchorWorkerOptions.SectionName));
        ...
        builder.Services.AddSingleton<IRecordArrRedactionOverlayReviewManifestProvider, ManifestRecordArrRedactionOverlayReviewManifestProvider>();
        builder.Services.AddSingleton<IRecordArrBackupVerificationManifestProvider, ManifestRecordArrBackupVerificationManifestProvider>();
        builder.Services.AddSingleton<IRecordArrAuditAnchorManifestProvider, ManifestRecordArrAuditAnchorManifestProvider>();
        ...
        builder.Services.AddHostedService<RecordArrRedactionOverlayReviewWorker>();
        builder.Services.AddHostedService<RecordArrBackupVerificationWorker>();
        builder.Services.AddHostedService<RecordArrAuditAnchorWorker>();
