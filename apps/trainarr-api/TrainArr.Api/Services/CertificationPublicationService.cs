...
public sealed class CertificationPublicationService(
    ...
    StaffArrTrainingBlockerClient staffArrClient,
    ...
    StaffArrCertificationLifecycleClient staffArrLifecycleClient)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await staffArrClient.PublishBlockerAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await staffArrClient.ClearBlockerAsync(
            new StaffArrClearTrainingBlockerPayload(tenantId, staffarrPersonId, publicationId),
            cancellationToken);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await staffArrGrantClient.IngestGrantAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        await staffArrLifecycleClient.IngestLifecycleAsync(
            new StaffArrIngestCertificationLifecyclePayload(
                request.TenantId,
                request.StaffarrPersonId,
