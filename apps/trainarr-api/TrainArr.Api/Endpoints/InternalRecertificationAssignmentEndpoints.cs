...
public static class InternalRecertificationAssignmentEndpoints
{
    public static void MapTrainArrInternalRecertificationAssignmentEndpoints(this WebApplication app)
    {
        var internalApi = app.MapGroup("/api/internal/recertification")
            .WithTags("Internal");
        ...
        internalApi.MapGet("/pending", async (
            ...
            RecertificationAssignmentService service,
        ...
        .WithName("InternalListPendingRecertificationAssignments");
        ...
        .WithName("InternalProcessRecertificationAssignments");
    }
        ...
        Guid? tenantId)
    {
        ...
        if (!string.Equals(preview.SourceProductKey, "shared-worker", StringComparison.OrdinalIgnoreCase))
        {
            throw new StlApiException(
                ...
                "Service token source product is not authorized for recertification assignment.",
                403);
        }
        ...
        tokenValidator.ValidateOrThrow(
            ...
            new ServiceTokenRequirements
            {
                ...
                RequiredActionScope = RecertificationAssignmentService.ProcessAssignmentsActionScope
            });
    }
}
