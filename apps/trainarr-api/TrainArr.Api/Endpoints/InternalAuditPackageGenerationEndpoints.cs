...
{
    public static void MapTrainArrInternalAuditPackageGenerationEndpoints(this WebApplication app)
    {
        ...
        .WithName("InternalListPendingTrainArrAuditPackageGenerationJobs");
        ...
        .WithName("InternalProcessTrainArrAuditPackageGenerationJobs");
    }
