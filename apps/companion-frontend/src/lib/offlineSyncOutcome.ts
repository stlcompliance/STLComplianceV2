import type { CompanionOfflineActionRejectedItem } from '../api/types'
...
export function isRetryableOfflineRejection(reasonCode: string): boolean {
  return reasonCode === CompanionFieldValidationReasonCodes.InboxUnavailable
}
...
export function partitionRejectedItems(items: CompanionOfflineActionRejectedItem[]): {
