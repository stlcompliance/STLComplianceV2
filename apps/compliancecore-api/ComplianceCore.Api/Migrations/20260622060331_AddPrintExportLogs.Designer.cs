...
namespace ComplianceCore.Api.Migrations
{
    ...
    [Migration("20260622060331_AddPrintExportLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComplianceCore.Api.Entities.QuestionnaireAnswer", b =>
                {
                    ...
                    b.Property<string>("NormalizedFactKey")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("NormalizedFactValue")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");

                    b.Property<string>("NormalizedFactValueType")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<Guid>("QuestionnaireRunId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SourceContextJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("TenantId", "QuestionnaireRunId", "QuestionKey")
                        .IsUnique();

                    b.ToTable("compliancecore_questionnaire_answers", (string)null);
                });

            modelBuilder.Entity("ComplianceCore.Api.Entities.QuestionnaireRun", b =>
                {
                    b.Property<Guid>("QuestionnaireRunId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("KnownFactsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("SourceRecordContextJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasKey("QuestionnaireRunId");

                    b.HasIndex("TenantId");

                    b.HasIndex("TenantId", "Status", "UpdatedAt");

                    b.HasIndex("TenantId", "ProductKey", "WorkflowKey", "SubjectType", "SubjectId", "SourceRecordId")
                        .IsUnique();

                    b.ToTable("compliancecore_questionnaire_runs", (string)null);
                });
            ...
            modelBuilder.Entity("ComplianceCore.Api.Entities.QuestionnaireAnswer", b =>
                {
                    ...
                    b.HasOne("ComplianceCore.Api.Entities.QuestionnaireRun", "Run")
                        .WithMany()
