  ...
  render(
    <QueryClientProvider client={client}>
      <TripsPanel
        ...
        canPerform
        canManage
        canOverrideSupplierReadiness={false}
        viewAllTrips
...
describe('TripsPanel', () => {
  it('renders trip list and create form', () => {
    ...
    expect(screen.getByPlaceholderText('Optional SupplyArr supplierOrderId')).toBeInTheDocument()
  })
})
