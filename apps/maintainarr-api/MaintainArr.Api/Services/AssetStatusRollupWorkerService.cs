    ...
    IMaintainArrAuditService audit)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var normalizedStalenessHours = AssetStatusRollupRules.NormalizeStalenessHours(stalenessHours);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var stalenessHours = AssetStatusRollupRules.NormalizeStalenessHours(request.StalenessHours);
        var candidates = await LoadPendingCandidatesAsync(
            request.TenantId,
            asOf,
            stalenessHours,
    ...
    private async Task<IReadOnlyList<PendingAssetCandidate>> LoadPendingCandidatesAsync(
        ...
        CancellationToken cancellationToken)
    {
        var enabledTenantIds = await db.TenantAssetStatusRollupSettings
            .AsNoTracking()
