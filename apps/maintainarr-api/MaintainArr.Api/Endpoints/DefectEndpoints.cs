...
public static class DefectEndpoints
{
    ...
    {
        var group = app.MapGroup("/api/defects").WithTags("Defects").RequireAuthorization();
        ...
        var inspectionGroup = app.MapGroup("/api/inspections").WithTags("Inspections").RequireAuthorization();
        ...
        .WithName("CreateDefectsFromInspectionRun");
    }
}
