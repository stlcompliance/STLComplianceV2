...
public static class AuditPackageEndpoints
{
    public static void MapMaintainArrAuditPackageEndpoints(this WebApplication app)
    {
        ...
        foreach (var (route, suffix) in groups)
        {
            ...
            .WithName($"GetAuditPackageManifest{suffix}");
            ...
            .WithName($"GetMaintainArrAuditPackageFilterOptions{suffix}");
            ...
            .WithName($"GetMaintainArrAuditPackageExportSummary{suffix}");
            ...
            .WithName($"GetMaintainArrAuditPackageTimeline{suffix}");
            ...
            .WithName($"ExportAuditPackage{suffix}");
            ...
            .WithName($"CreateMaintainArrAuditPackageGenerationJob{suffix}");
            ...
            .WithName($"GetMaintainArrAuditPackageGenerationJob{suffix}");
            ...
            .WithName($"DownloadMaintainArrAuditPackageGenerationJob{suffix}");
        }
    }
