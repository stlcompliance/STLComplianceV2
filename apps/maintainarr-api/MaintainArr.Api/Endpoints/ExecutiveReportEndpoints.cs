...
public static class ExecutiveReportEndpoints
{
    public static void MapMaintainArrExecutiveReportEndpoints(this WebApplication app)
    {
        ...
        {
            group = group.WithTags("ExecutiveReports").RequireAuthorization();
            ...
            .WithName($"GetMaintainArrExecutiveReportSummary{nameSuffix}");
            ...
            .WithName($"ExportMaintainArrExecutiveReportSummary{nameSuffix}");
        }

        MapRoutes(app.MapGroup("/api/reports/executive"), string.Empty);
        MapRoutes(app.MapGroup("/api/v1/reports/executive"), "V1");
    }
}
