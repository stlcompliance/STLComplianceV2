...
interface AssignmentMaterialDemandPanelProps {
  assignment: TrainingAssignmentDetailResponse
  demandLines: TrainingAssignmentMaterialDemandLineResponse[]
  statusEvents: TrainingAssignmentMaterialDemandStatusEventResponse[]
  canManage: boolean
  partNumber: string
...
function assignmentEditable(status: string): boolean {
...
export function AssignmentMaterialDemandPanel({
  assignment,
  demandLines,
  statusEvents,
  canManage,
  ...
  return (
    <section
      ...
      data-testid="assignment-material-demand"
    >
      ...
      {demandLines.length === 0 ? (
        <p className="mt-3 text-sm text-slate-400">No material demand lines yet.</p>
      ) : (
            ...
            >
              ...
              <div className="mt-1 text-xs text-slate-500">
                ...
                {line.supplyarrDemandRefId
                  ? ` · SupplyArr ref ${line.supplyarrDemandRefId.slice(0, 8)}…`
                  : ''}
