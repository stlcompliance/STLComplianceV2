...
{
    public static void MapStaffArrInternalAuditPackageGenerationEndpoints(this WebApplication app)
    {
        ...
        .WithName("InternalListPendingAuditPackageGenerationJobs");
        ...
        .WithName("InternalProcessAuditPackageGenerationJobs");
    }
