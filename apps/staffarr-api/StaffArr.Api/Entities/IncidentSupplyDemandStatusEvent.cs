...
public sealed class IncidentSupplyDemandStatusEvent : IHasTenant
{
...
public static class IncidentSupplyDemandProcurementStatuses
{
...
public static class IncidentSupplyDemandStatusEventTypes
{
    public const string PrDrafted = "pr_drafted";
