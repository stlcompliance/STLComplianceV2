...
await StlApiHost.RunAsync<StaffArrDbContext>(
    ...
    async app =>
    {
        ...
        app.MapStaffArrHiringEndpoints();
        ...
        app.MapStaffArrPersonAccountAccessEndpoints();
        app.MapStaffArrImportEndpoints();
        ...
        app.MapStaffArrInternalPersonProvisioningEndpoints();
