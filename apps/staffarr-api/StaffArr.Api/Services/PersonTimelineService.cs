...
public sealed class PersonTimelineService(StaffArrDbContext db)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var entries = await BuildTimelineEntriesAsync(tenantId, personId, cancellationToken);
    ...
    private async Task<List<PersonTimelineEntryResponse>> BuildTimelineEntriesAsync(
        Guid tenantId,
        Guid personId,
