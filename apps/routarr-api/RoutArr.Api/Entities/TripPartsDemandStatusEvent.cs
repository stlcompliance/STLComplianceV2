...
public sealed class TripPartsDemandStatusEvent : IHasTenant
{
...
public static class TripPartsDemandProcurementStatuses
{
...
public static class TripPartsDemandStatusEventTypes
{
    public const string PrDrafted = "pr_drafted";
