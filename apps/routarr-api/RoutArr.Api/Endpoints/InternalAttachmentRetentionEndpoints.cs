...
public static class InternalAttachmentRetentionEndpoints
{
    public static void MapRoutArrInternalAttachmentRetentionEndpoints(this WebApplication app)
    {
        var internalApi = app.MapGroup("/api/internal/attachment-retention")
            .WithTags("Internal");
        ...
        internalApi.MapGet("/pending", async (
            ...
            AttachmentRetentionWorkerService service,
        ...
        .WithName("InternalListPendingAttachmentRetention");
        ...
        .WithName("InternalProcessAttachmentRetention");
    }
        ...
        Guid? tenantId)
    {
        ...
        if (!string.Equals(preview.SourceProductKey, "shared-worker", StringComparison.OrdinalIgnoreCase))
        {
            throw new StlApiException(
                ...
                "Service token source product is not authorized for attachment retention purges.",
                403);
        }
        ...
        tokenValidator.ValidateOrThrow(
            ...
            new ServiceTokenRequirements
            {
                ...
                RequiredActionScope = AttachmentRetentionWorkerService.ProcessAttachmentRetentionActionScope
            });
    }
}
