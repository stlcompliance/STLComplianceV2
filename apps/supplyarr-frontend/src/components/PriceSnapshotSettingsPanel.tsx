  ...
  return (
    ...
    >
      ...
      {settingsQuery.isError && (
        <div className="mt-3">
          <ApiErrorCallout
            title="Price snapshot settings unavailable"
            message={getErrorMessage(settingsQuery.error, 'Failed to load price snapshot settings.')}
      ...
      <div className="mt-4 space-y-3">
        ...
        {saveMutation.isError && (
          <ApiErrorCallout
            title="Save failed"
            message={getErrorMessage(saveMutation.error, 'Failed to save price snapshot settings.')}
          />
        )}
      </div>
