    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-5 lg:col-span-2">
        ...
        <p className="mt-1 text-sm text-slate-400">
          SupplyArr owns the relationship between suppliers and procurement documents. Actual file
          storage, versions, retention, and document lifecycle remain owned by RecordArr.
        </p>
