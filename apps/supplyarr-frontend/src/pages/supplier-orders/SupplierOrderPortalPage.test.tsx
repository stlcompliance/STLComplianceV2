...
import { SupplierOrderPortalPage } from './SupplierOrderPortalPage'
import { submitSupplierAccessOrderStatus } from '../../api/supplierOrderClient'
...
vi.mock('../../api/supplierOrderClient', () => ({
  getSupplierAccessOrder: vi.fn().mockResolvedValue({
    ...
    metadata: {
      ...
      supplierPortalStatusOptions: [
        { value: 'acknowledged', label: 'Acknowledged', owner: 'supplyarr', sourceOfTruth: 'supplyarr.supplier_order.workflow' },
        { value: 'in_progress', label: 'In progress', owner: 'supplyarr', sourceOfTruth: 'supplyarr.supplier_order.workflow' },
        { value: 'partially_ready', label: 'Partially ready', owner: 'supplyarr', sourceOfTruth: 'supplyarr.supplier_order.workflow' },
        { value: 'completed_ready_for_dispatch', label: 'Completed ready for dispatch', owner: 'supplyarr', sourceOfTruth: 'supplyarr.supplier_order.workflow' },
        { value: 'unable_to_fulfill', label: 'Unable to fulfill', owner: 'supplyarr', sourceOfTruth: 'supplyarr.supplier_order.workflow' },
      ],
      documentTypeOptions: [
...
describe('SupplierOrderPortalPage', () => {
  it('requires readiness confirmation before allowing a ready-for-pickup update', async () => {
    ...
    const { submitSupplierAccessOrderStatus } = await import('../../api/supplierOrderClient')
    await waitFor(() => {
