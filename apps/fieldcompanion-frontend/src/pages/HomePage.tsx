...
export function HomePage() {
  ...
  const inboxQuery = useQuery({
    queryKey: ['fieldcompanion-field-inbox', session?.accessToken],
  ...
  useFieldCompanionWebPush(session?.accessToken)
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <FieldScanPanel
        ...
        onResolved={(result: FieldCompanionScanResolveResponse) => {
