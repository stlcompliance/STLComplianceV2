...
export function LaunchPage() {
  ...
  useEffect(() => {
    ...
    if (!handoff) {
      setError('Missing handoff code. Launch OrdArr from the suite.')
      return
    }
  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-6">
      <div className="ordarr-panel max-w-md p-8 text-center shadow-2xl">
        {error ? (
          <>
          ...
          <p className="text-slate-300">Redeeming OrdArr handoff...</p>
        )}
      </div>
    </main>
  )
